...
@csrf
    <div class="row m-b30">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="company_contact_no" name="company_contact_no" value="{{ isset($employerDetails->company_contact_no) ? $employerDetails->company_contact_no : '' }}" placeholder="Enter Company Contact Phone">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="gst_number" value="{{ isset($employerDetails->gst_no) ? $employerDetails->gst_no : '' }}" placeholder="Enter GST Number" value="">
    ...
    <div class="row m-b30">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                <label>Zip</label>
                <input type="text" class="form-control" name="zip" id="zip" value="{{ isset($employerDetails->zip) ? $employerDetails->zip : '' }}" placeholder="Enter Zip">
            </div>
        </div>
        <div class="col-lg-12 col-md-12">
            <div class="form-group">
