...
<section class="exec-section">
    <div class="exec-container">
       ...
       <p><span style="font-weight: bold; color: black;">Liftale Staffing Service </span>delivers proven leaders who drive transformation</p>

        <p>Hiring executive talent is one of the most critical decisions your organization will make. At <span style="font-weight: bold;"> Liftale </span>, our <span style="font-weight: bold;">Executive</span> Search service is designed to identify, attract, and secure top-tier leadership for your most vital roles—quietly, confidently, and with precision.</p>

        <h3 class="exec-subheading">What is Executive Search?</h3>
        <p class="exec-text">Executive Search is a highly specialized recruitment process for senior leadership and C-suite roles. It requires discretion, insight, and access to a network of passive candidates who are not actively job-seeking—but are open to the right opportunity.</p>
        ...
        <p class="exec-text">Whether you’re a startup scaling fast or an enterprise undergoing transformation, Liftale helps you secure executives who bring vision, execution, and long-term impact.</p>
