...
<!-- Permanent Staffing Services Section -->
<section class="perm-section">
    <div class="perm-container">
        <h2 class="perm-heading">Permanent Staffing Services</h2>
        <p class="perm-subtitle">Hire Right. Hire Once. With Liftale Staffing Services.</p>
        <p class="perm-text">Finding the right person for a long-term role is more than just matching a résumé to a job description—it’s about aligning skills, values, and long-term goals.</p>
        <p class="perm-text">At Liftale Staffing Services, we specialize in permanent recruitment that delivers the right talent the first time.</p>

        <h3 class="perm-subheading">What is Permanent Recruitment?</h3>
        <p class="perm-text">Permanent recruitment focuses on identifying, attracting, and hiring full-time employees who are a long-term fit for your organization. Liftale acts as your strategic hiring partner—managing the entire recruitment lifecycle from sourcing to placement.</p>
        ...
        <p class="perm-text">Whether you’re scaling fast, replacing a critical role, or building a high-performing team. Our permanent staffing solutions provide you with top-tier talent who are in it for the long haul.</p>

        <h3 class="perm-subheading">For Job Seekers</h3>
        <p class="perm-text">Looking for your next career move? Liftale connects talented professionals with companies that value your skills and ambition. We match you with roles where you can thrive long-term.</p>

        <div class="perm-contact">
            <p><strong>Let’s Build Your Team</strong></p>
            <p>Ready to make your next great hire? Contact Liftale Staffing Services today for trusted, tailored permanent recruitment solutions that work.</p>
        </div>
    </div>
</section>
<style>
